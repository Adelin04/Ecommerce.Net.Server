        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FKProductId = table.Column<long>(name: "FK_ProductId", type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductImages_Products_FK_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stock = table.Column<long>(type: "bigint", nullable: false),
                    FKProductId = table.Column<long>(name: "FK_ProductId", type: "bigint", nullable: false),
                    FKSizeId = table.Column<long>(name: "FK_SizeId", type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_FK_ProductId",
                table: "ProductImages",
                column: "FK_ProductId");
